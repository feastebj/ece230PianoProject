...
//                                 {00,01,02,03,04,05,07,09,10,12,14,16,18,50,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00}};
    int neoPixelNote[12][30] = { { 1, 2, 3, 4, 5, 9, 10, 14, 15, 19},
                                 { 1, 2, 3, 4, 5, 9, 10, 14, 15, 19, 26, 28, 30,
                                   31, 32, 33, 34, 36, 38, 40, 41, 42, 43, 44,
                                   46, 48},
                                 { 0, 1, 2, 3, 4, 5, 9, 10, 14, 16, 17, 18},
                                 { 0, 1, 2, 3, 4, 5, 9, 10, 14, 16, 17, 18, 26,
                                   28, 30, 31, 32, 33, 34, 36, 38, 40, 41, 42,
                                   43, 44, 46, 48},
                                 { 0, 1, 2, 3, 4, 5, 7, 9, 10, 12, 14, 15, 19
                                   },
                                 { 0, 1, 2, 3, 4, 7, 9, 12, 14, 19},
                                 { 0, 1, 2, 3, 4, 7, 9, 12, 14, 19, 26, 28, 30,
                                   31, 32, 33, 34, 36, 38, 40, 41, 42, 43, 44,
                                   46, 48 },
                                 { 0, 1, 2, 3, 4, 5, 9, 10, 12, 14, 15, 16, 17,
                                   19},
                                 { 0, 1, 2, 3, 4, 5, 9, 10, 12, 14, 15, 16, 17,
                                   19, 26, 28, 30, 31, 32, 33, 34, 36, 38, 40,
                                   41, 42, 43, 44, 46, 48 },
                                 { 0, 1, 2, 3, 7, 9, 12, 14, 15, 16, 17, 18},
                                 { 0, 1, 2, 3, 4, 5, 7, 9, 10, 12, 14, 16, 18,
